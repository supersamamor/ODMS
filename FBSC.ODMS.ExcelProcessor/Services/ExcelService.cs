...
using FBSC.ODMS.ExcelProcessor.CustomValidation;
			...
			if (listOfErrorsPerColumn != null)
			{
				foreach (var kvp in listOfErrorsPerColumn)
				{
					...
					foreach (var value in values)
					{
						...
						{
							if (recordToUpdate.Data.TryGetValue(Constants.ExcelUploadErrorRemarks, out object? recordToUpdateValue))
							{
        ...
        private async Task<Dictionary<string, object?>> CustomValidationPerRecordHandler(string module, Dictionary<string, object?> rowValue)
        {
            ...
            switch (module)
            {
				...
				case nameof(DataSourceSchemaCacheState):
					return await DataSourceSchemaCacheValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DataUploadBatchState):
					return await DataUploadBatchValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DataUploadColumnState):
					return await DataUploadColumnValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(ReportTypeState):
					return await ReportTypeValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardQueryState):
					return await DashboardQueryValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardQueryParameterState):
					return await DashboardQueryParameterValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardQueryResultColumnState):
					return await DashboardQueryResultColumnValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardQueryResultCacheState):
					return await DashboardQueryResultCacheValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardThemeState):
					return await DashboardThemeValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardState):
					return await DashboardValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardWidgetState):
					return await DashboardWidgetValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(AiSqlPromptTemplateState):
					return await AiSqlPromptTemplateValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(AiSqlGenerationRequestState):
					return await AiSqlGenerationRequestValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardRefreshJobState):
					return await DashboardRefreshJobValidator.ValidatePerRecordAsync(_context, rowValue);
				case nameof(DashboardAccessState):
					return await DashboardAccessValidator.ValidatePerRecordAsync(_context, rowValue);
            ...
            switch (module)
            {
                case nameof(DataSourceState):
					return DataSourceValidator.DuplicateValidation(records);
																case nameof(ReportTypeState):
					return ReportTypeValidator.DuplicateValidation(records);
				case nameof(DashboardQueryState):
					return DashboardQueryValidator.DuplicateValidation(records);
																case nameof(DashboardThemeState):
					return DashboardThemeValidator.DuplicateValidation(records);
				case nameof(DashboardState):
					return DashboardValidator.DuplicateValidation(records);
