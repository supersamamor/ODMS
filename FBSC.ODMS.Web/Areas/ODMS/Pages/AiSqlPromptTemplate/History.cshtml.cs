...
[Authorize(Policy = Permission.AiSqlPromptTemplate.History)]
public class HistoryModel : BasePageModel<HistoryModel>
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        _ = (await Mediatr.Send(new GetAiSqlPromptTemplateByIdQuery(id))).Select(l=> Mapper.Map(l, AiSqlPromptTemplate));  
