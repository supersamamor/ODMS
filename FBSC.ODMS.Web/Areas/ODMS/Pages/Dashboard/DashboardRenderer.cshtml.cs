...
{
    public class DashboardRendererModel(AIDataAnalyticsServices aiDataAnalyticsServices, FBSC.HTMLTemplate.Services.RotativaService rotativaService) : BasePageModel<DashboardRendererModel>
    {
        [BindProperty]
