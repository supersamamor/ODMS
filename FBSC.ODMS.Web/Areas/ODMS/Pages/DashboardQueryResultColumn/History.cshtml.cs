...
[Authorize(Policy = Permission.DashboardQueryResultColumn.History)]
public class HistoryModel : BasePageModel<HistoryModel>
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        _ = (await Mediatr.Send(new GetDashboardQueryResultColumnByIdQuery(id))).Select(l=> Mapper.Map(l, DashboardQueryResultColumn));  
