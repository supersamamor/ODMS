...
public class EditModel : BasePageModel<EditModel>
{
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditDashboardQueryResultColumnCommand>(DashboardQueryResultColumn)), "Details", true);
    }	
	public PartialViewResult OnPostChangeFormValue()
    {
        ModelState.Clear();
		
        return Partial("_InputFieldsPartial", DashboardQueryResultColumn);
    }
