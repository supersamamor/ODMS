...
public class EditModel : BasePageModel<EditModel>
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        return await PageFrom(async () => await Mediatr.Send(new GetDashboardWidgetByIdQuery(id)), DashboardWidget);
    }
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditDashboardWidgetCommand>(DashboardWidget)), "Details", true);
    }	
	public PartialViewResult OnPostChangeFormValue()
    {
        ModelState.Clear();
		
        return Partial("_InputFieldsPartial", DashboardWidget);
    }
