...
public class EditModel : BasePageModel<EditModel>
{
    ...
    public async Task<IActionResult> OnGet(string? id)
    {
        ...
        return await PageFrom(async () => await Mediatr.Send(new GetDashboardQueryResultCacheByIdQuery(id)), DashboardQueryResultCache);
    }
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditDashboardQueryResultCacheCommand>(DashboardQueryResultCache)), "Details", true);
    }	
