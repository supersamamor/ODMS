...
public class GreaterThanEqualAttribute(string otherProperty) : BaseValidationAttribute
{
...
public class GreaterThanEqualAttributeAdapter(GreaterThanEqualAttribute attribute,
                                            IStringLocalizer? stringLocalizer) : AttributeAdapterBase<GreaterThanEqualAttribute>(attribute, stringLocalizer)
{
