...
public class DecimalRangeAttribute(double minimum, double maximum) : BaseValidationAttribute
{
...
public class DecimalRangeAttributeAdapter(DecimalRangeAttribute attribute, IStringLocalizer? stringLocalizer) : AttributeAdapterBase<DecimalRangeAttribute>(attribute, stringLocalizer)
{
