...
public class GreaterThanAttribute(string otherProperty) : BaseValidationAttribute
{
...
public class GreaterThanAttributeAdapter(GreaterThanAttribute attribute,
                                            IStringLocalizer? stringLocalizer) : AttributeAdapterBase<GreaterThanAttribute>(attribute, stringLocalizer)
{
