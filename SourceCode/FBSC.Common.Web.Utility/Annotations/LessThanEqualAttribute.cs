...
public class LessThanEqualAttribute(string otherProperty) : BaseValidationAttribute
{
...
public class LessThanEqualAttributeAdapter(LessThanEqualAttribute attribute, IStringLocalizer? stringLocalizer) : AttributeAdapterBase<LessThanEqualAttribute>(attribute, stringLocalizer)
{
