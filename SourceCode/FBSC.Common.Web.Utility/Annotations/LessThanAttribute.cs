...
public class LessThanAttribute(string otherProperty) : BaseValidationAttribute
{
...
public class LessThanAttributeAdapter(LessThanAttribute attribute, IStringLocalizer? stringLocalizer) : AttributeAdapterBase<LessThanAttribute>(attribute, stringLocalizer)
{
