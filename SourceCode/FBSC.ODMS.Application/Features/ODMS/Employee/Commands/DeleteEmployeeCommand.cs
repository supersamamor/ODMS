...
public class DeleteEmployeeCommandHandler(ApplicationContext context,
                                   IMapper mapper,
                                   CompositeValidator<DeleteEmployeeCommand> validator) : BaseCommandHandler<ApplicationContext, EmployeeState, DeleteEmployeeCommand>(context, mapper, validator), IRequestHandler<DeleteEmployeeCommand, Validation<Error, EmployeeState>>
{ 
