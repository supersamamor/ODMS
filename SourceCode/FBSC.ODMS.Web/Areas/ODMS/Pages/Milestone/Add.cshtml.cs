...
[Authorize(Policy = Permission.Milestone.Create)]
public class AddModel : BasePageModel<AddModel>
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<AddMilestoneCommand>(Milestone)), "Details", true);
    }	
