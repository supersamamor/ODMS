...
[Authorize(Policy = HTMLTemplatePermission.HTMLTemplate.Edit)]
public class EditModel : BasePageModel<EditModel>
{
    ...
    {		
        ...
        return await TryThenRedirectToPage(async () => await Mediatr.Send(Mapper.Map<EditHTMLTemplateCommand>(HTMLTemplateForm)), "Details", true);
    }	
