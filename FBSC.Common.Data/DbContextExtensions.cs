...
public static class DbContextExtensions
{
	...
	/// <summary>
	/// Attaches an entity to the context and marks only the specified properties as modified.
	/// </summary>
	/// <typeparam name="TEntity">The type of the entity.</typeparam>
	/// <param name="context">The DbContext.</param>
	/// <param name="entity">The entity to attach.</param>
	/// <param name="modifiedProperties">An array of property names to mark as modified.</param>
	public static void AttachAndMarkModified<TEntity>(
		this DbContext context,
		TEntity entity,
		params Expression<Func<TEntity, object?>>[] modifiedProperties) where TEntity : class
	{
		context.Attach(entity);
		foreach (var propertyExpression in modifiedProperties)
		{
	...
	/// <summary>
	/// Helper method to extract property name from lambda expression.
	/// </summary>
	private static string GetPropertyName<TEntity>(Expression<Func<TEntity, object?>> expression)
	{
		return expression.Body switch
		{
			...
			_ => throw new ArgumentException("Invalid expression format.")
		};
	}
}
