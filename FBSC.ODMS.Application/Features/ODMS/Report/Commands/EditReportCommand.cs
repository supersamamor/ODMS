...
public class EditReportCommandHandler(ApplicationContext context,
                                 IMapper mapper,
                                 CompositeValidator<EditReportCommand> validator) : BaseCommandHandler<ApplicationContext, ReportState, EditReportCommand>(context, mapper, validator), IRequestHandler<EditReportCommand, Validation<Error, ReportState>>
{
	...
	{
		IList<ReportQueryFilterState> reportQueryFilterListForDeletion = [];
    ...
    {
        IList<ReportRoleAssignmentState> reportRoleAssignmentListForDeletion = [];
